...
$ERROR_MESSAGES = [
    ...
    'required' => "This field is required, it cannot be empty.",
    ...
    'past_date' => "The date cannot be a past date.",
    'checkout' => "Checkout date cannot be before check-in date"
];
...
$RULES = [
    ...
    'required' => true,
    'sanitize_filter' => null,
    'error_message_key' => 'confpassword'
    ],
    'checkin' => [
    'value' => '',
    'validering' => null,
